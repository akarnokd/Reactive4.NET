...
{
    [TestFixture]
    abstract class FlowableProcessorVerification<T> : IdentityProcessorVerification<T>
    {
        protected FlowableProcessorVerification() : base(new TestEnvironment(25))
        {
        }

        protected FlowableProcessorVerification(int timeout) : base(new TestEnvironment(timeout))
        {
        }
