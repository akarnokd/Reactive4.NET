...
namespace Reactive4.NET
{
    ...
    public static class Flowable
    {
        ...
        {
            return source.IgnoreElementsTask(cts.Token);
        }
        ...
        /// <param name="cancellationToken">The cancellation token to observe for cancellation.</param>
        /// <returns>The new Task instance.</returns>
        public static Task IgnoreElementsTask<T>(this IFlowable<T> source, CancellationToken cancellationToken)
        {
            var s = new TaskIgnoreElementsSubscriber<T>(cancellationToken);
            source.Subscribe(s);
            return s.Task;
        }
